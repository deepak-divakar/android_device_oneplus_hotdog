...
$(call inherit-product, device/oneplus/hotdog/lineage_hotdog.mk)
...
PRODUCT_NAME := maru_hotdog
PRODUCT_MODEL := Maru on the OnePlus 7t Pro
MARU_VERSION := 0.8-test
MARU_BUILD_VERSION := $(MARU_VERSION)-$(shell date -u +%Y%m%d)

DEVICE_PACKAGE_OVERLAYS += \
    device/oneplus/hotdog/overlay_maru/daydream
